<div class="dropdown position-relative"> 
    <button class="btn btn-outline-none border-0 shadow-none dropdown-toggle mt-1" type="button" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
