<div class="dropdown position-relative"> 
    <button class="btn btn-outline-light bg-transparent border-0 shadow-none dropdown-toggle pt-2 mt-2" type="button" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
        <i class="bi bi-bell-fill fs-5"></i>
        <span id="unreadNotificationCount" class="badge bg-danger" style="font-size: 11px; margin-left: -10px;"></span> 
    </button>
